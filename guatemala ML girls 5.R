...
data        <- read.dta13(paste(data.path,"/girlshet.dta",sep=""), convert.factors = "FALSE") # read in the data set
...
affected       <- c("edad_en_meses", "girl_zwei", "girl_zlen", "gpsaltitude", "rain_maydec2015", "max30_maydec2015", "AME", "dep_ratio", "edu", "hhwealth", "dirtfloor", "micronutr", "bono", "womanwealth", "credit", "market_distance", "water", "electric", "hhsoc_capital", "womansoc_capital", "Lfoodcons_perc", "Lcalorias_percap", "LASFproteina_percap", "Legg_freq", "LFCS", "Legg_price", "Leggs_consumed", "Legg_production", "Lchicken_num")
...
#write.csv(r,(paste(data.path,"/girls_ml_output.csv",sep=""))) # save it to a csv
write.csv(r,"girls_ml_output.csv") # save it to a csv
