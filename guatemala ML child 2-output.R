...
###########################
# Code to output the results of "guatemala ML child 2.r" to csv and tex
###########################

# To use this code, run "guatemala ML child 2.r" up to the point that the main estimation loop finishes,
...
# load("~/Dropbox (UFL)/guatemala-chickens/ML-child-results-after-ptm.Rdata")
...
# BEGIN code from "guatemala ML child 2.r"
###########################

write.csv(r,(paste(output.path,"/child_ml_output.csv",sep=""))) # save it to a csv
...
write.csv(results_all2,(paste(output.path,"/child_results_all2.csv",sep=""))) # save it to a csv
write.csv(results_het_all2,(paste(output.path,"/child_results_het_all2.csv",sep=""))) # save it to a csv
write.csv(test_all2,(paste(output.path,"/child_test_all2.csv",sep=""))) # save it to a csv
write.csv(bestML_all,(paste(output.path,"/child_bestML_all.csv",sep=""))) # save it to a csv
write.csv(table.who_all2,(paste(output.path,"/child_table.who_all2.csv",sep=""))) # save it to a csv
...
write.csv(CLAN_final,(paste(output.path,"/child_CLAN_final.csv",sep=""))) # save it to a csv
write.csv(GATES_final,(paste(output.path,"/child_GATES_final.csv",sep=""))) # save it to a csv
write.csv(BLP_final,(paste(output.path,"/child_BLP_final.csv",sep=""))) # save it to a csv
write.csv(BEST_final,(paste(output.path,"/child_BEST_final.csv",sep=""))) # save it to a csv
...
print(xtable(BEST_final.w.rownames, 
      ...
      file = paste0(output.path, "/child_BEST_final.tex"), 
...
if (ML.methods.to.separate.files) {
  ...
  print(xtable(GATES_final.1, 
        ...
        file = paste0(output.path, "/child_GATES_final_", gsub(" ", "_", method_names[1]), ".tex"), 
        include.rownames = FALSE)
  
  print(xtable(GATES_final.2, 
             align = c("l", "l", rep("c", ncol(GATES_final.2) - 1))), 
        file = paste0(output.path, "/child_GATES_final_", gsub(" ", "_", method_names[2]), ".tex"), 
        include.rownames = FALSE)
  ...
  print(xtable(BLP_final.1, 
        ...
        file = paste0(output.path, "/child_BLP_final_", gsub(" ", "_", method_names[1]), ".tex"), 
        include.rownames = FALSE)
  
  print(xtable(BLP_final.2, 
             align = c("l", "l", rep("c", ncol(BLP_final.2) - 1))), 
        file = paste0(output.path, "/child_BLP_final_", gsub(" ", "_", method_names[2]), ".tex"), 
        include.rownames = FALSE)
  ...
  print(xtable(GATES_final.w.rownames, 
        ...
        file = paste0(output.path, "/child_GATES_final.tex"), 
        include.rownames = FALSE)
